...
export default function Home() {
    ...
    return (
        <>
            <View style={styles.mainContainer}>
                <View style={styles.headContainer}>
                    ...
                    <TouchableOpacity style={[styles.addButton, styles.shadowProp]}>
                        <Feather name="plus" size={28} padding={12} color="#86BA85" />
                    </TouchableOpacity>
                </View>
            ...
            <ImageBackground source={require('../assets/background-homepage.png')} resizeMode="cover" style={styles.backgroundImage} />
        </>
    );
}
